        ...
        if (fname_error != '' ||  lname_error != '' || email_error != '' || phone_error != '' || address1_error != '' || address2_error != '' || city_error != '' || state_error != '' || country_error != '' || pincode_error != '' )
          {
         ...
         else
           {
              var data = {
               ...
               $.ajax({
                method: "POST",
                url: "http://localhost/ecommerce/public/proceed-to-pay",
                data:data,
                success: function(response) {
                    //   alert(response.total_price)

                    var options = {
                        "key": "rzp_test_luE1MkufSj2qOW", // Enter the Key ID generated from the Dashboard
                        ...
                        "handler": function (responsea){
                          ...
                          $.ajax({
                            ...
                            success: function (responseb) {
                              ...
                              .then((value) => {
                                window.location.href='http://localhost/ecommerce/public/my-orders';
                              });
                        ...
                        "prefill": { //We recommend using the prefill parameter to auto-fill customer's contact information, especially their phone number
                            "name": response.firstname, //your customer's name
                            "email": response.email,
